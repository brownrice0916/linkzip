        ...
        {step === 2 && (
          <div className="space-y-5 animate-in fade-in duration-200">
            ...
            <div className="p-4 bg-gray-100 rounded-2xl flex items-center justify-between">
              <div>
                <div className="text-xs font-extrabold text-gray-900">테스트 알림톡 발송</div>
                <div className="text-[11px] text-gray-500">{phoneNumber} 번호로 시뮬레이션 발송</div>
              </div>

              <button
                onClick={handleSendTestMessage}
                className="px-4 py-2 bg-black hover:bg-gray-800 text-white rounded-xl font-bold text-xs transition cursor-pointer flex items-center gap-1.5"
              >
            ...
            {testSent && (
              <div className="p-3 bg-blue-50 text-blue-800 text-xs font-bold rounded-xl text-center border border-blue-200 animate-in fade-in">
                💬 [카카오 알림톡 테스트] 시뮬레이션 알림톡이 {phoneNumber} 번호로 성공적으로 전송되었습니다!
              </div>
            )}
