...
const themes = [
  ...
  { id: 'grid', name: 'Neo Lime ⚡', classes: 'bg-lime-300 border-2 border-black text-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]' },
  { id: 'neo-pink', name: 'Neo Pink ⚡', classes: 'bg-pink-400 border-2 border-black text-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]' },
  { id: 'neo-cyan', name: 'Neo Cyan ⚡', classes: 'bg-cyan-300 border-2 border-black text-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]' },
  { id: 'neo-yellow', name: 'Neo Yellow ⚡', classes: 'bg-yellow-300 border-2 border-black text-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]' },
