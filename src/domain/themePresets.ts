...
export const themeDesignPresets: Record<string, ThemeDesignPreset> = {
  ...
  'neon-dark': { backgroundColor: '#111827', pageTextColor: '#FFFFFF', pageTextOpacity: 100, backgroundOpacity: 100, buttonStyle: 'solid', buttonRoundness: 'full', buttonShadow: 'strong', buttonColor: '#1F2937', buttonTextColor: '#818CF8', buttonOpacity: 100, buttonTextOpacity: 100, fontFamily: 'Inter', titleFontFamily: '', sticker: '' },
  'soft-gradient': { backgroundColor: '#C4B5FD', pageTextColor: '#312E81', pageTextOpacity: 100, backgroundOpacity: 100, buttonStyle: 'glass', buttonRoundness: 'full', buttonShadow: 'strong', buttonColor: '#FFFFFF', buttonTextColor: '#312E81', buttonOpacity: 78, buttonTextOpacity: 100, fontFamily: 'Inter', titleFontFamily: '', sticker: '' },
  air: { backgroundColor: '#F3F4F6', pageTextColor: '#111827', pageTextOpacity: 100, backgroundOpacity: 100, buttonStyle: 'solid', buttonRoundness: 'full', buttonShadow: 'soft', buttonColor: '#FFFFFF', buttonTextColor: '#111827', buttonOpacity: 100, buttonTextOpacity: 100, fontFamily: 'Inter', titleFontFamily: '', sticker: '' },
...
export const themeWallpaperStyles: Record<string, ThemeWallpaperStyle> = {
  ...
  'neo-pop': {
    ...
    backgroundImage: 'linear-gradient(135deg, rgba(255,255,255,.26) 25%, transparent 25%), linear-gradient(225deg, rgba(255,255,255,.18) 25%, transparent 25%), linear-gradient(145deg, #FDE047, #F472B6 48%, #818CF8)',
    backgroundPosition: '-18px 0, -18px 0, 0 0',
